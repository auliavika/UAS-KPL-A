...
public class TestTambahLaporan extends base {
    ...
    public static void main(String[] args) throws Exception {
     ...
     // Tunggu hingga semua elemen dengan resourceId muncul
        ...
        driver.findElementByXPath("//android.widget.CompoundButton[@resource-id=\"com.example.mobilebalikin:id/foundButton\"]").click();
        ...
        driver.findElementByXPath("//android.widget.Button[@resource-id='com.example.mobilebalikin:id/addImageButton']").click();
	     ...
	     driver.findElementByXPath("//android.widget.EditText[@resource-id='com.example.mobilebalikin:id/descriptionEditText']")
	         .sendKeys("Laptop merk lenovo warna putih");
	     ...
	     // Klik submit button
	     driver.findElementByXPath("//android.widget.Button[@resource-id='com.example.mobilebalikin:id/submitButton']").click();
