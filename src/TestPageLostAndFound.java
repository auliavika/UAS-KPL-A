...
public class TestPageLostAndFound extends base {
    ...
    public static void main(String[] args) throws Exception {
     ...
     // Isi Email
        ...
        AndroidElement hilangTab = (AndroidElement) wait.until(
            ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.LinearLayout[@content-desc=\"Hilang\"]")));
        hilangTab.click();

        // Tunggu sebentar biar halaman load
        Thread.sleep(2000);

        // Klik tab "Ditemukan"
        AndroidElement ditemukanTab = (AndroidElement) wait.until(
            ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.LinearLayout[@content-desc=\"Ditemukan\"]")));
        ditemukanTab.click();
